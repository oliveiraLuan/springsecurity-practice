...
public class SecurityConfig {
    ...
    public RegisteredClientRepository registeredClientRepository(){
        //Uma instância de RegisteredClientRepository para gerir clients
    ...
    public JWKSource<SecurityContext> jwkSource(){
        //Uma instância de JWKSource para assinar acess tokens
    ...
    private static KeyPair generateRsaKey(){
        //Gerar par de chave valor com algoritmo RSA
        KeyPair keyPair;
        try{
    ...
    public JwtDecoder jwtDecoder(JWKSource<SecurityContext> jwkSource){
        //Uma instância de JwtDecoder para decodificar acess tokens assinados
        return OAuth2AuthorizationServerConfiguration.jwtDecoder(jwkSource);
    }
    @Bean
    public AuthorizationServerSettings authorizationServerSettings(){
        //Uma instância de AuthorizationServerSettings para configurar Authorization Server
